...
import clawOpen from '../assets/ui/gameplay/claw-open.webp'
import clawHoldingBlue from '../assets/ui/gameplay/claw-holding-blue.webp'
import clawHoldingWhite from '../assets/ui/gameplay/claw-holding-white.webp'
import clawHoldingBlack from '../assets/ui/gameplay/claw-holding-black.webp'
import clawHoldingSilver from '../assets/ui/gameplay/claw-holding-silver.webp'
...
.cable {
  ...
  transition: height 0.62s cubic-bezier(0.32, 0.72, 0.32, 1);
}
.claw-img {
  width: 108px;
  height: 108px;
...
.phase-pause .claw-img { animation: anticipate 0.3s ease both; }
.phase-descend .claw-img { animation: none; }
.phase-grip .claw-img { animation: grip 0.36s cubic-bezier(0.34, 1.56, 0.64, 1) both; }
.phase-ascend .claw-img { animation: none; }
.phase-settle .claw-img { animation: settle 0.36s ease both; }
